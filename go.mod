...
require (
	...
	github.com/operator-framework/catalogd v0.35.1-0.20241029151942-a049e01e3cc2
	github.com/operator-framework/operator-controller v0.17.1-0.20241030100925-87dfebe168b2
	github.com/operator-framework/operator-lifecycle-manager v0.23.1
	github.com/operator-framework/operator-registry v1.48.1-0.20241030095615-70aa21e2d405
